...
export default function ProcessSection() {
  ...
  return (
    <section
      ref={ref}
      id="process"
      className="relative overflow-hidden bg-[#0B0B0F] px-6 py-20 text-white lg:py-28"
    >
      <div className="absolute left-[-120px] top-[-120px] h-[320px] w-[320px] rounded-full bg-indigo-600/10 blur-[120px]" />
      <div className="absolute bottom-[-120px] right-[-120px] h-[280px] w-[280px] rounded-full bg-violet-500/10 blur-[120px]" />
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        <div className="mt-14 grid gap-8 lg:gap-10">
          ...
          <motion.div
            ...
            className="grid items-center gap-10 rounded-[2rem] border border-white/5 bg-white/[0.02] p-6 sm:p-8 lg:grid-cols-2"
          >
            <div className="text-center lg:text-left">
              ...
              <div className="mx-auto mt-5 h-[2px] w-10 rounded-full bg-gradient-to-r from-indigo-400 to-violet-400 lg:mx-0" />
            </div>
            ...
            <div className="relative flex h-[260px] items-center justify-center sm:h-[320px]">
              ...
              <div className="absolute h-[260px] w-[260px] rounded-full bg-indigo-500/10 blur-3xl sm:h-[320px] sm:w-[320px]" />

              <motion.div
                animate={{ y: [0, -8, 0] }}
                transition={{ repeat: Infinity, duration: 6.5 }}
                className="absolute top-0 left-1/2 -translate-x-1/2 rounded-2xl border border-indigo-400/30 bg-white/5 p-4 backdrop-blur-xl sm:p-5"
              >
                <svg
              ...
              <motion.div
                ...
                className="absolute left-4 bottom-14 rounded-2xl border border-violet-400/30 bg-white/5 p-4 backdrop-blur-xl sm:left-10 sm:p-5"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="2.4em"
              ...
              <motion.div
                ...
                className="absolute right-4 top-1/2 -translate-y-1/2 rotate-[12deg] rounded-2xl border border-indigo-300/30 bg-white/5 p-4 backdrop-blur-xl sm:right-10 sm:p-5"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="2.4em"
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.7 }}
            className="rounded-[2rem] border border-white/5 bg-white/[0.02] px-6 py-10 sm:px-8"
          >
            ...
            <div className="mt-10 grid grid-cols-1 gap-4 md:grid-cols-3">
              {step2Cards.map((card, i) => {
                ...
                return (
                  ...
                  >
                    <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-indigo-500/25 to-violet-500/25 opacity-0 blur-xl transition duration-300 group-hover:opacity-100" />

                    <div className="relative z-10 flex h-full min-h-[190px] flex-col rounded-2xl border border-white/10 bg-white/[0.04] p-5 backdrop-blur-xl">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.7 }}
            className="grid gap-8 rounded-[2rem] border border-white/5 bg-white/[0.02] p-6 sm:p-8 lg:grid-cols-2"
          >
            <div>
              <p className="text-xs uppercase tracking-[0.35em] text-indigo-300">
                03
